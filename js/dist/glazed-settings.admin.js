(function($, Drupal) {
  ...
  Drupal.behaviors.glazedSettingsControls = {
    attach(context) {
      ...
      var $input = "";
      $("#system-theme-settings .form-type-radio .control-label").each(
        function() {
          $(this).once("myslider", function() {
            $input = $(this)
              ...
              .remove();
            $(this)
              .wrapInner('<span class="glazed-label">')
              .prepend($input);
          });
        }
      );
      ...
      $("#edit-nav-font-size").change(function() {
        $(
          ".glazed-header--top #glazed-main-menu .nav > li > a, .glazed-header--side #glazed-main-menu .nav a"
      ...
      $("#edit-block-well").change(function() {
        $(".block-preview .block").removeClass(
          "well bg-primary glazed-util-background-accent1 glazed-util-background-accent2 glazed-util-background-black glazed-util-background-white glazed-util-background-gray"
        );
